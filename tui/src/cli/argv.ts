// ccq CLI 子命令骨架的 argv 解析（动词路由 + 对象解析）。
// 长远命名空间：ls | use | rm | add | config | mcp | skills | tools | update
// 本次实现路由：tui(无参) / --version / --help / help / ls / use / update / tools / uninstall；未知动词 → 提示 help。
//
// 设计要点：
